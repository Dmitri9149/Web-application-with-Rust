...
pub async fn get_member_details_db(pool: &PgPool, member_id: i32) -> Member {
    // Prepare SQL statement
...
pub async fn post_new_member_db(pool: &PgPool, new_member: NewMember) -> Member {
...
pub async fn delete_member_db(pool: &PgPool, member_id: i32) -> String {
